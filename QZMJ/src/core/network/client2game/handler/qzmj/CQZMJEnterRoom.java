 ...
 *
 */
public class CQZMJEnterRoom extends PlayerHandler {
	...
	public void handle(Player player, WebSocketRequest request, String message) throws IOException {
		...
		// 进入房间
		SData_Result result = player.getFeature(PlayerRoom.class).findAndEnter(req.getPosID(), req.getRoomKey(),
				req.getClubId(), req.getPassword());
