...
public class SQZMJ_StartVoteDissolve extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 发起人
	...
	public static SQZMJ_StartVoteDissolve make(long roomID, int createPos, int endSec) {
		SQZMJ_StartVoteDissolve ret = new SQZMJ_StartVoteDissolve();
