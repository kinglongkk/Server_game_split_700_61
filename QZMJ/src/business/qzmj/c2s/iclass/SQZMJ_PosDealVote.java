...
public class SQZMJ_PosDealVote extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 位置
	private int pos;
	...
	public static SQZMJ_PosDealVote make(long roomID, int pos, boolean agreeDissolve) {
		SQZMJ_PosDealVote ret = new SQZMJ_PosDealVote();
