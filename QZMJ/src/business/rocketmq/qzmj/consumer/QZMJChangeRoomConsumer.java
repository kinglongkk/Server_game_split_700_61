 ...
 */
@Consumer(topic = MqTopic.BASE_CHANGE_ROOM, id = QZMJAPP.gameTypeId)
public class QZMJChangeRoomConsumer extends BaseChangeRoomConsumer implements MqConsumerHandler {
