 ...
 */
@Consumer(topic = MqTopic.BASE_CHANGE_ROOM, id = PDKAPP.gameTypeId)
public class PDKChangeRoomConsumer extends BaseChangeRoomConsumer implements MqConsumerHandler {
