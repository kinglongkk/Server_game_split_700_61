...
public class SPDK_PosDealVote extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 位置
	private int pos;
	...
	public static SPDK_PosDealVote make(long roomID, int pos, boolean agreeDissolve) {
		SPDK_PosDealVote ret = new SPDK_PosDealVote();
