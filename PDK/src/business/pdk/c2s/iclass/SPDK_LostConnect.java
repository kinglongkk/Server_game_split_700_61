...
public class SPDK_LostConnect extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 玩家PID
	private long pid;
	...
	public static SPDK_LostConnect make(long roomID, long pid, boolean isLostConnect,boolean isShowLeave) {
		SPDK_LostConnect ret = new SPDK_LostConnect();
