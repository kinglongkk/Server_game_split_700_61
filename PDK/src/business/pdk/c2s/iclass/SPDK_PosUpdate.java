...
public class SPDK_PosUpdate extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 玩家位置
	private int pos;
	...
	public static SPDK_PosUpdate make(long roomID, int pos, RoomPosInfo posInfo, int custom) {
		SPDK_PosUpdate ret = new SPDK_PosUpdate();
