...
public class SPDK_StartVoteDissolve extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 发起人
	...
	public static SPDK_StartVoteDissolve make(long roomID, int createPos, int endSec) {
		SPDK_StartVoteDissolve ret = new SPDK_StartVoteDissolve();
