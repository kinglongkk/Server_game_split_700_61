...
public class SPDK_Trusteeship extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 玩家PID
	private long pid;
	...
	public static SPDK_Trusteeship make(long roomID, long pid, int pos, boolean trusteeship) {
		SPDK_Trusteeship ret = new SPDK_Trusteeship();
