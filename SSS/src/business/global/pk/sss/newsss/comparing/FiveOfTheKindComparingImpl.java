 ...
 * 五同的大小比较(直接比较炸弹)
 */
public class FiveOfTheKindComparingImpl extends AbstractComparing {
	...
	public int compare(PlayerDun o1, PlayerDun o2) {
		...
		int ret = this.multiComparing(p1CardMap, p2CardMap, 5);
