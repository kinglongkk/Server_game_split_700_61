...
public class FourOfTheKindComparingImpl extends AbstractComparing {
	...
	public int compare(PlayerDun o1, PlayerDun o2) {
		...
		int ret = this.multiComparing(p1CardMap, p2CardMap, 4);
