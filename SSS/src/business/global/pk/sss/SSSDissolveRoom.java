...
public class SSSDissolveRoom extends DissolveRoom {
    public SSSDissolveRoom(AbsBaseRoom room, int createPos,int WaitSec) {
     ...
     * @return
     */
    private boolean checkAllAgreeSSS() {
