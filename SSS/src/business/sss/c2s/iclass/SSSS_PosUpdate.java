...
import business.sss.c2s.cclass.SSSRoom_Pos;
import jsproto.c2s.cclass.BaseSendMsg;
import jsproto.c2s.cclass.room.RoomPosInfo;


public class SSSS_PosUpdate extends BaseSendMsg {
    ...
    public static SSSS_PosUpdate make(long roomID, int pos, RoomPosInfo posInfo, int custom) {
        SSSS_PosUpdate ret = new SSSS_PosUpdate();
