...
public class SNN_LostConnect extends BaseSendMsg {
    // 房间ID
    private long roomID;
    // 玩家PID
    private long pid;
    ...
    public static SNN_LostConnect make(long roomID, long pid, boolean isLostConnect, boolean isShowLeave) {
        SNN_LostConnect ret = new SNN_LostConnect();
