...
public class SNN_PosDealVote extends BaseSendMsg {
    // 房间ID
    private long roomID;
    // 位置
    private int pos;
    ...
    public static SNN_PosDealVote make(long roomID, int pos, boolean agreeDissolve) {
        SNN_PosDealVote ret = new SNN_PosDealVote();
