 ...
 * @description: 退出房间
 */
@Consumer(topic = MqTopic.BASE_EXIT_ROOM, id = DZPKAPP.gameTypeId)
public class DZPKExitRoomConsumer extends BaseExitRoomConsumer implements MqConsumerHandler {
