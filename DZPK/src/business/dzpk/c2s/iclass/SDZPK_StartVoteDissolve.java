...
public class SDZPK_StartVoteDissolve extends BaseSendMsg {
    // 房间ID	
    private long roomID;
    // 发起人	
    ...
    public static SDZPK_StartVoteDissolve make(long roomID, int createPos, int endSec) {
        SDZPK_StartVoteDissolve ret = new SDZPK_StartVoteDissolve();
