...
public class PromotionLevelCacheConfiguration extends BaseCacheConfiguration {
    /**
     * 堆缓存大小 单位KB
     */
    private final int HEAP_CACHE_SIZE = 1024;
     ...
     * ehcache缓存超时时间 单位秒
     */
    private final int EHCACHE_TTL = 30;
    ...
    public void init(CacheManager cacheManager) {
        // 缓存对象
        this.setCache(cacheManager.getCache("preConfigured",String.class, byte[].class));
