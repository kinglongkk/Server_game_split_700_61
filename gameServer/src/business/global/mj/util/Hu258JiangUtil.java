...
public class Hu258JiangUtil {
	...
	private volatile static Hu258JiangUtil singleton;

	private Hu258JiangUtil() {
	}

	public static Hu258JiangUtil getInstance() {
		if (singleton == null) {
			synchronized (Hu258JiangUtil.class) {
				if (singleton == null) {
					singleton = new Hu258JiangUtil();
				}
			}
		}
		return singleton;
