...
@TableName(value = "SportsPointChargeLog")
@Data
public class SportsPointChargeLogFlow extends BaseClarkLogEntity<SportsPointChargeLogFlow> {
    ...
    private long roomId;
    public SportsPointChargeLogFlow() {
    }

    public SportsPointChargeLogFlow(long pid, long clubId, long unionId, int reason, double num, double curRemainder, double preValue, int type, int gameId, int cityId,long roomId) {
        this.pid = pid;
        this.clubId = clubId;
