 ...
 */
@TableName(value = "RoomPromotionPointLog", dbDay = TableName.DbDayEnum.NEXT_DAY)
@Data
@NoArgsConstructor
public class RoomPromotionPointLogNextDayFlow extends RoomPromotionPointLogFlow {
