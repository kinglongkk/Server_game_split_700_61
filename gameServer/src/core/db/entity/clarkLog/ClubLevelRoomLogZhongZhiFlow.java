 ...
 */
@TableName(value = "ClubLevelRoomLogZhongZhi", dbDay = TableName.DbDayEnum.EVERY_6DAY)
@Data
@NoArgsConstructor
public class ClubLevelRoomLogZhongZhiFlow extends BaseClarkLogEntity<ClubLevelRoomLogZhongZhiFlow> {
    ...
    public ClubLevelRoomLogZhongZhiFlow(String date_time, long pid, int winner, double consume, long roomId, long upLevelId, long memberId, int point, double sportsPoint, int setCount, double sportsPointConsume, double roomSportsPointConsume, double roomAvgSportsPointConsume, long clubId, long unionId, double promotionShareValue,long playGamePid) {
    ...
    public String getInsertSql() {
        return "INSERT INTO ClubLevelRoomLogZhongZhi" +String.valueOf(CommTime.getCycleNowTime6YMD())
    ...
    public static String getCreateTableSQL() {
        return getCreateTableSQL(String.valueOf(CommTime.getNowTime6YMD()));
    }

    public static String getCreateTableSQL(String dateTime) {
        String sql = "CREATE TABLE IF NOT EXISTS `ClubLevelRoomLogZhongZhi" + dateTime + "` ("
                ...
                + ") COMMENT='玩家推广员及下属消耗中至' DEFAULT CHARSET=utf8";
        return sql;
    }
