...
import core.db.entity.clarkLog.ClubLevelRoomLogNotDayFlow;
...
public class ClubLevelRoomLogNotDayFlowService implements BaseService<ClubLevelRoomLogNotDayFlow> {
    private BaseClarkLogDao<ClubLevelRoomLogNotDayFlow> clubLevelRoomLogFlowDao = new BaseClarkLogDao<>(ClubLevelRoomLogNotDayFlow.class);
