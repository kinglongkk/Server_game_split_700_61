 ...
 *
 */
public class CUnionMemberList extends PlayerHandler {
	...
	public void handle(Player player, WebSocketRequest request, String message)
    	...
    	SData_Result result = UnionMgr.getInstance().getUnionMemberMgr().getUnionMemberList(req.getUnionId(),req.getPageNum(),req.getQuery());
