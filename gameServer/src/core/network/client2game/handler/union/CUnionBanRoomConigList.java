 ...
 * 赛事禁止玩法列表
 */
public class CUnionBanRoomConigList extends PlayerHandler {
    @Override
    public void handle(Player player, WebSocketRequest request, String message) throws WSException, IOException {
        final CUnion_BanRoomConfigOp req = new Gson().fromJson(message, CUnion_BanRoomConfigOp.class);
        SData_Result result = UnionMgr.getInstance().getUnionMemberMgr().getUnionBanRoomConfigList(req, player.getPid());
