 ...
 *查询推广员身上的分成信息
 */
public class CClubAlivePointWaningInfo extends PlayerHandler {
    @Override
    public void handle(Player player, WebSocketRequest request, String message) throws WSException, IOException {
        ...
        SData_Result result = ClubMgr.getInstance().getClubMemberMgr().getAlivePointWaningInfo(sportsPointWarningChange,player.getPid());
