 ...
 * 获取指定亲友圈信息
 * @authot zaf
 * TODO 2022/06/01 该接口与club.CGetClubListById功能一致客户端要求增加,处理时最好在onGetClubListByPlayerByClubId方法内统一处理
 *
 * */

public class CGetClubListByClubId extends PlayerHandler {
