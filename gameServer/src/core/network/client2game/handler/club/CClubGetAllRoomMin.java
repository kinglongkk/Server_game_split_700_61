...
import jsproto.c2s.iclass.club.SClub_GetAllRoomMin;
 ...
 * @author zaf
 */
public class CClubGetAllRoomMin extends PlayerHandler {
    ...
    public void handle(Player player, WebSocketRequest request, String message)
        ...
        player.pushProto(SClub_GetAllRoomMin.make(club.getClubListBO().getId(),ClubMgr.getInstance().onClubGetAllRoomShort(req.getClubId(),req.getPageNum())));
