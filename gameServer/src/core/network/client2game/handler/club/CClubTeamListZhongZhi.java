 ...
 * 推广列表
 */
public class CClubTeamListZhongZhi extends PlayerHandler {
    @Override
    public void handle(Player player, WebSocketRequest request, String message) throws WSException, IOException {
        CClub_PromotionList club_promotionList=new Gson().fromJson(message, CClub_PromotionList.class);
        SData_Result result = ClubMgr.getInstance().getClubMemberMgr().getTeamListZhongZhi(club_promotionList,player.getPid());
